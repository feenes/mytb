...
"""
This is a copy of https://github.com/sametmax/minibelt
It's under zlib licence.

As the module is no more maintained it has been included into mytb

Modifications will be done on a need as is basis.
